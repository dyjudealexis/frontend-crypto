        ...
        <div className="grid lg:grid-cols-2 items-center gap-20">
          ...
          >
            <p className="sm:text-28 text-18 text-muted mb-4">
              Manage your <span className="text-primary">Digital Assets</span>
            </p>
            <h2 className="text-white sm:text-40 text-30 mb-4 font-medium">
              Build and track your crypto portfolio with
              <span className="text-primary"> CrypGo</span>!
            </h2>
            <p className="text-muted text-opacity-60 text-18">
              Discover the tools and insights that help you make smarter
              <br className="md:block hidden" /> investment decisions.
            </p>
