  ...
  const services = [
    {
      ...
      text: "Expert Blockchain Guidance",
    },
    {
      icon: "images/icons/icon-blockchain.svg",
      text: "Innovative Blockchain Tech",
    },
    {
      icon: "images/icons/icon-Services.svg",
      text: "Tailored Software Solutions",
    },
  ];
        ...
        <div ref={ref} className="grid grid-cols-12 items-center">
          ...
          >
            <p className="sm:text-28 text-18 text-white">
              Partner with <span className="text-primary">our team</span>
            </p>
            <h2 className="sm:text-40 text-30 text-white lg:w-full md:w-70% font-medium">
              Launch your blockchain venture with confidence.
            </h2>
